...
export class BaseService {
  ...
  private async sendRequest(method: HttpMethod, url: string, body: { headers?: Record<string, string>; data?: object } = {}): Promise<APIResponse> {
  ...
  async get(url: string, body: { headers?: Record<string, string>; data?: object } = {}): Promise<APIResponse> {
    return this.sendRequest('GET', url, body);
  }

  async post(url: string, body: { headers?: Record<string, string>; data?: object }): Promise<APIResponse> {
    return this.sendRequest('POST', url, body);
  }
  async put(url: string, body: { headers?: Record<string, string>; data?: object }): Promise<APIResponse> {
    return this.sendRequest('PUT', url, body);
  }

  async delete(url: string, body: { headers?: Record<string, string>; data?: object } = {}): Promise<APIResponse> {
